...
import { Q as QueryClient, s as setAccessToken, j as jsxDevRuntimeExports, a as QueryClientProvider, A as App } from './App-tUP9pkzs.js';
  ...
  if (!ready) {
    return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "p-8 text-center", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "animate-spin h-8 w-8 border-4 border-amber-400 border-t-transparent rounded-full mx-auto" }, void 0, false, {
        fileName: "C:/github/betsson/copilot-worktrees/eShopAcademy/lucaslofaro-betsson-scaling-invention/src/Frontend/eshop-sellers/src/SellerDashboard.tsx",
        lineNumber: 32,
        columnNumber: 9
      }, this),
